  ...
  return (
    <div className="min-h-screen dotted-paper flex flex-col items-center justify-center p-4">
      <div className="paper-card p-10 max-w-md w-full text-center rotate-[1deg]">
        ...
        <p className="text-ink/60 font-semibold mb-3">joining is almost here 😅</p>
        <p className="text-ink/40 font-medium text-sm mb-8">we're filling up the rooms, check back soon!</p>
